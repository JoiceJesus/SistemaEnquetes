    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full">
      ...
      <div class="lg:col-span-7 space-y-8">
        ...
        <div class="grid grid-cols-3 gap-4 pt-2">
          <div class="bg-white dark:bg-gray-800 p-4 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm transition-colors">
            <p class="text-2xl font-bold text-indigo-600 dark:text-indigo-400">12k+</p>
            <p class="text-xs text-gray-500 dark:text-gray-400 font-medium mt-0.5">Votos Computados</p>
          </div>
          <div class="bg-white dark:bg-gray-800 p-4 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm transition-colors">
            <p class="text-2xl font-bold text-emerald-600 dark:text-emerald-400">100%</p>
            <p class="text-xs text-gray-500 dark:text-gray-400 font-medium mt-0.5">Transparência</p>
          </div>
          <div class="bg-white dark:bg-gray-800 p-4 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm transition-colors">
            <p class="text-2xl font-bold text-amber-600 dark:text-amber-400">24/7</p>
      ...
      <div id="auth-card" class="lg:col-span-5 w-full max-w-md mx-auto">
        ...
        <div class="text-center mt-4 flex justify-center gap-3">
          <a href="enquete?acao=novo" class="text-xs text-indigo-600 hover:underline font-medium">Criar enquete</a>
