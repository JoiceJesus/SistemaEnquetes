...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (optionsContainer && btnAddOption) {
    btnAddOption.addEventListener('click', () => {
      ...
      div.innerHTML = `
        <input type="text" required name="opcao" placeholder="Opção ${count}" class="option-input w-full px-4 py-2.5 bg-gray-50 dark:bg-gray-700/50 border border-gray-300 dark:border-gray-600 rounded-lg text-sm dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500">
